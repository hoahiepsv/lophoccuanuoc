      ...
      <header className="bg-emerald-900 text-white py-2 px-4 shadow-md sticky top-0 z-50 no-print">
        <div className="container mx-auto flex flex-col md:flex-row justify-between items-center gap-2 md:gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            >
               <button className="p-2 bg-emerald-800 rounded-full hover:bg-emerald-700 transition border border-emerald-700 shadow-inner">
               ...
               {showSettings && (
                 <div className="absolute right-0 top-full mt-2 w-72 bg-white rounded-xl shadow-2xl p-4 border border-emerald-100 animate-fadeIn z-[60]">
                    <p className="text-[10px] font-black text-emerald-900 uppercase mb-3 border-b border-emerald-50 pb-2 flex items-center gap-2">
